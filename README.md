...
| [`@sinjoh/sdk`](./packages/sdk) | Core SDK: byte-exact configuration codecs (router, raffle, airdrop/liquidity sinks) with local validation, Pons v2 launch prediction, EIP-1167 clone verification, and custom-error decoding with operator guidance. Every codec is pinned to a fixture generated by the owning Solidity package. |
